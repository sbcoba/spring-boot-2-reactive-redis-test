...
import com.sbcoba.test.redis.rule.RequiresRedisServer;
...
public class JacksonJsonTests {
	...
	public void shouldWriteAndReadPersonObject() {
		...
		StepVerifier.create(get) //
				.expectNext("{\"_type\":\"com.sbcoba.test.redis.Person\",\"firstname\":\"Homer\",\"lastname\":\"Simpson\"}") //
				.verifyComplete();
	...
	public void shouldWriteAndReadEmailObject() {
		...
		StepVerifier.create(get) //
				.expectNext("{\"_type\":\"com.sbcoba.test.redis.EmailAddress\",\"address\":\"homer@the-simpsons.com\"}") //
				.verifyComplete();
